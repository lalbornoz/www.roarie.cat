function Matrix (w, h, f) {
  ...
  this.w = w; this.h = h; this.x = this.y = 0
  this.initialize()
}
...
//   if (canvas.grid) { ch++ }
  ...
  if (this.rotated) {
    ...
    // this.wrapper.style.left = ((canvas_wrapper.offsetHeight+20)/2) + "px"
  }
  else {
    ...
    // canvas_wrapper.style.left = "auto"
  }
}
// }}}
